# EDM_AM_Cd0.R - EDM calculation script

# 0. Initialization ----
workspace_file <- "AM_Cd0_workspace.RData"
progress_file <- "AM_Cd0_progress.rds"
log_file <- "edm_am_cd0.log" 
