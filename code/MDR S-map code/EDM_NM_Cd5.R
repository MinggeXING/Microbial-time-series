# EDM_NM_Cd5.R - EDM calculation script

# 0. Initialization ----
workspace_file <- "NM_Cd5_workspace.RData"
progress_file <- "NM_Cd5_progress.rds"
log_file <- "edm_nm_cd5.log" 

# Ensure log directory exists
if(!dir.exists(dirname(log_file))) dir.create(dirname(log_file), recursive = TRUE)

# Initialize log
cat(paste(Sys.time(), "===== Script started (cd5) =====\n"), file = log_file, append = TRUE)
...
# 10. Save and exit ----
save.image(file = "NM_Cd5_workspace.RData")
log_message("===== Script execution finished (cd5) =====\n")