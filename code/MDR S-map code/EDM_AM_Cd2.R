# EDM_AM_Cd2.R - EDM calculation script

# 0. Initialization ----
workspace_file <- "AM_Cd2_workspace.RData"
progress_file <- "AM_Cd2_progress.rds"
log_file <- "edm_am_cd2.log" 
