# EDM_NM_Cd15.R - EDM calculation script

# 0. Initialization ----
workspace_file <- "NM_Cd15_workspace.RData"
progress_file <- "NM_Cd15_progress.rds"
log_file <- "edm_nm_cd15.log" 

# Ensure log directory exists
if(!dir.exists(dirname(log_file))) dir.create(dirname(log_file), recursive = TRUE)

# Initialize log
cat(paste(Sys.time(), "===== Script started (cd15) =====\n"), file = log_file, append = TRUE)
...
# 5. Custom function current_alf: safely run task ----
...
# 6. Progress management function alf ----
...
# 10. Save and exit ----
save.image(file = "NM_Cd15_workspace.RData")
log_message("===== Script execution finished (cd15) =====\n")