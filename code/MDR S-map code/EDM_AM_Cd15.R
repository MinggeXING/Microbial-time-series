# EDM_AM_Cd15.R - EDM calculation script

# 0. Initialization ----
workspace_file <- "AM_Cd15_workspace.RData"
progress_file <- "AM_Cd15_progress.rds"
log_file <- "edm_am_cd15.log" 
