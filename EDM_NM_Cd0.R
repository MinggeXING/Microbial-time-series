# EDM_NM_Cd0.R - EDM calculation script

# 0. Initialization ----
workspace_file <- "NM_Cd0_workspace.RData"
progress_file <- "NM_Cd0_progress.rds"
log_file <- "edm_nm_cd0.log" 
